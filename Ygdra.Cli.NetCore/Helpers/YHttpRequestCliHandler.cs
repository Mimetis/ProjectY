...
{
    public class YHttpRequestCliHandler : IYHttpRequestHandler
    {
        ...
        public YHttpRequestCliHandler(IYAuthProvider authProvider, IHttpClientFactory httpClientFactory,
