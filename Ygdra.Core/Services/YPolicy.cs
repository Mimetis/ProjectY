...
namespace Ygdra.Core.Services
{
    ...
    public class YPolicy
    {
        ...
        private Func<Exception, int, TimeSpan, Task> onRetryAsync;
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                while (true)
                {
                    ...
                    if (onRetryAsync != null)
                        await onRetryAsync(handledException, tryCount, waitDuration);
        ...
        /// </summary>
        public static YPolicy RetryForever() => WaitAndRetry(-1, TimeSpan.Zero, null, null);

        /// <summary>
        /// Gets a policy retrying forever with no delay and a predicate used to define whether a policy handles a given exception
        /// </summary>
        public static YPolicy RetryForever(Func<Exception, bool> isRetriable, Func<Exception, int, TimeSpan, Task> onRetry = null)
            => WaitAndRetry(-1, null, isRetriable, onRetry);

        /// <summary>
        /// Gets a policy retrying for a defined number of iterations, with no delay
        /// </summary>
        public static YPolicy Retry(int retryCount = 1) => WaitAndRetry(retryCount, TimeSpan.Zero);
        ...
        /// </summary>
        public static YPolicy Retry(int retryCount, Func<Exception, bool> isRetriable, Func<Exception, int, TimeSpan, Task> onRetry = null)
        ...
        /// </summary>
        public static YPolicy WaitAndRetryForever(TimeSpan sleepDuration = default)
        ...
        /// </summary>
        public static YPolicy WaitAndRetryForever(Func<int, TimeSpan> sleepDurationProvider, Func<Exception, bool> isRetriable, Func<Exception, int, TimeSpan, Task> onRetry = null)
        ...
        /// </summary>
        public static YPolicy WaitAndRetry(int retryCount, TimeSpan sleepDuration = default)
            => WaitAndRetry(retryCount, new Func<int, TimeSpan>(_ => sleepDuration), new Func<Exception, bool>(_ => true), null);
        ...
        /// </summary>
        public static YPolicy WaitAndRetry(int retryCount, TimeSpan sleepDuration, Func<Exception, bool> isRetriable, Func<Exception, int, TimeSpan, Task> onRetry = null)
        ...
        /// </summary>
        public static YPolicy WaitAndRetry(int retryCount, Func<int, TimeSpan> sleepDurationProvider,
                                                              Func<Exception, bool> isRetriable,
                                                              Func<Exception, int, TimeSpan, Task> onRetry = null)
        {
            var policy = new YPolicy { RetryCount = retryCount };
            ...
            policy.onRetryAsync = onRetry ?? new Func<Exception, int, TimeSpan, Task>((ex, rc, waitDuration) => Task.CompletedTask);
            return policy;
        }
    }
