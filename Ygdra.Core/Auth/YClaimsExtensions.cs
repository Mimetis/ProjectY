...
namespace Ygdra.Core.Auth
{
    ...
    /// </summary>   
    public static class YClaimsExtensions
    {
        /// <summary>
        ...
        public static string GetMsalAccountId(this ClaimsPrincipal claimsPrincipal)
        {
            ...
            string uniqueObjectIdentifier = claimsPrincipal.GetObjectId();
            string uniqueTenantIdentifier = claimsPrincipal.GetTenantId();
        ...
        {
            string userObjectId = claimsPrincipal.FindFirstValue(YClaimConstants.Oid);
            if (string.IsNullOrEmpty(userObjectId))
            {
                userObjectId = claimsPrincipal.FindFirstValue(YClaimConstants.ObjectId);
            }
        ...
        {
            string tenantId = claimsPrincipal.FindFirstValue(YClaimConstants.Tid);
            if (string.IsNullOrEmpty(tenantId))
            {
                return claimsPrincipal.FindFirstValue(YClaimConstants.TenantId);
            }
        ...
        public static string GetDisplayName(this ClaimsPrincipal claimsPrincipal)
        {
            ...
            string displayName = claimsPrincipal.FindFirstValue(YClaimConstants.PreferredUserName);
            ...
            return claimsPrincipal.FindFirstValue(YClaimConstants.Name);
        }
        ...
        {
            string userFlowId = claimsPrincipal.FindFirstValue(YClaimConstants.Tfp);
            if (string.IsNullOrEmpty(userFlowId))
            {
                return claimsPrincipal.FindFirstValue(YClaimConstants.UserFlow);
            }
